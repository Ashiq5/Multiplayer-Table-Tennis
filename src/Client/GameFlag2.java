...
public class GameFlag2 implements Serializable
{
    private String element;
    int servelost,upward,bat_hit,serve,score1,score2,fk,f,go;
    double centerX,centerY,radiusX,g,h;

    public GameFlag2(String element,double l,double m,int a,int b,int c,int d,int e,int f,int g,int h,int i,double centerX,double centerY,double radiusX) {
